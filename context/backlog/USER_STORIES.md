...
> scheduled, assign it a milestone in GitHub.

## Issues

| # | Item | Origin |
| - | ---- | ------ |
| [#21](https://github.com/tembo/agent-studio/issues/21) | Org-level policy templates | Moved from v0.4 (US-0.4-03) |
| [#22](https://github.com/tembo/agent-studio/issues/22) | Agent labels + group-by view | Backlog note |
| [#23](https://github.com/tembo/agent-studio/issues/23) | Per-agent + workspace PR policy (YOLO auto-merge) | Moved from v0.2 (US-0.2-03/04); blocked on Tembo CAP direct-commit |
| [#24](https://github.com/tembo/agent-studio/issues/24) | Scheduled agent-guidance refresh | Backlog note (pairs with v0.4 lean CAP prompt) |
| [#25](https://github.com/tembo/agent-studio/issues/25) | Self-extending TAS via customer fork | Backlog note |
| [#26](https://github.com/tembo/agent-studio/issues/26) | CI: run RBAC deny-tests on every PR | Moved from v0.4 scope-cut |

## What goes here vs. an in-phase Deferred section

- **In-phase `Stretch (Considered, Deferred)`** — stories that were
