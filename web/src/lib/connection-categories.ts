...
export const CATEGORY_META: Record<ConnectionCategory, CategoryMeta> = {
  ...
  email: { label: "Email", supported: true, slugs: ["gmail", "outlook", "microsoftoutlook"] },
  calendar: { label: "Calendar", supported: true, slugs: ["googlecalendar", "outlookcalendar"] },
  notify: { label: "Slack", supported: true, slugs: ["slack", "microsoftteams"] },
  helpdesk: { label: "Helpdesk", supported: true, slugs: ["pylon", "zendesk", "intercom", "freshdesk", "front", "helpscout"] },
  recorder: { label: "Call recorder", supported: true, slugs: ["avoma", "fathom", "gong", "fireflies"] },
  accounting: { label: "Accounting", supported: true, slugs: ["quickbooks", "xero", "netsuite"] },
  payments: { label: "Payments", supported: true, slugs: ["stripe"] },
  analytics: { label: "Product analytics", supported: true, slugs: ["metabase", "amplitude", "mixpanel", "posthog", "googleanalytics"] },
  warehouse: { label: "Data warehouse", supported: true, slugs: ["metabase", "snowflake", "bigquery"] },
  docs: { label: "Docs / knowledge", supported: true, slugs: ["notion", "googledocs", "googledrive", "confluence", "coda"] },
  issues: { label: "Issue tracker", supported: true, slugs: ["linear", "jira", "github", "asana", "clickup"] },
  ...
  monitoring: { label: "Monitoring", supported: false, slugs: [] },
  itsm: { label: "ITSM", supported: false, slugs: [] },
  identity: { label: "Identity / SSO", supported: false, slugs: [] },
  ads: { label: "Ads", supported: false, slugs: [] },
  seo: { label: "SEO / search", supported: false, slugs: [] },
