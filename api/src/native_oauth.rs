...
const NATIVE_MCP_OAUTH_ALLOWLIST: &[(&str, &[&str])] = &[
    ...
    // ── Batch 2026-07 (#3): registry + connectors-directory sweep. Inline
    // tuples (mcp origin → allowed OAuth origins) rather than named consts;
    // kept in the same order as web/src/lib/mcp-providers.ts, which the
    // allowlist-sync vitest guards against drift. Origins are the union of
    // the advertised authorization server + authorize/token/registration
    // endpoint origins from the 2026-07-18 probe.
    // ── Sales / GTM ──
    ("https://api.outreach.io", &["https://api.outreach.io"]),
    ("https://mcp.salesloft.com", &["https://accounts.salesloft.com", "https://mcp.salesloft.com"]),
    ("https://mcp.zoominfo.com", &["https://mcp.zoominfo.com", "https://okta-login.zoominfo.com"]),
    ("https://mcp.lusha.com", &["https://auth.lusha.com"]),
    ("https://mcp.hunter.io", &["https://hunter.io"]),
    ("https://mcp.instantly.ai", &["https://api.instantly.ai"]),
    ("https://mcp.crossbeam.com", &["https://mcp.crossbeam.com"]),
    ("https://mcp.api.harmonic.ai", &["https://mcp.api.harmonic.ai"]),
    ("https://fire.chilipiper.com", &["https://fire.chilipiper.com"]),
    ("https://day.ai", &["https://day.ai"]),
    ("https://api.clarify.ai", &["https://auth1.clarify.ai"]),
    ("https://mcp.staircase.ai", &["https://mcp.staircase.ai"]),
    // ── Support / CX ──
    ("https://mcp.zendesk.com", &["https://mcp.zendesk.com"]),
    ("https://mcp.helpscout.net", &["https://mcp.helpscout.net"]),
    ("https://mcp.gorgias.com", &["https://mcp.gorgias.com"]),
    ("https://mcp.plain.com", &["https://signin.auth.plain.com"]),
    ("https://api.lorikeetcx.ai", &["https://api.lorikeetcx.ai", "https://app.lorikeetcx.ai"]),
    ("https://app.unthread.io", &["https://app.unthread.io"]),
    ("https://wisdom-api.enterpret.com", &["https://oauth.enterpret.com"]),
    ("https://dovetail.com", &["https://auth.dovetail.com"]),
    ("https://mcp.missiveapp.com", &["https://auth.missiveapp.com"]),
    // ── Meeting intelligence ──
    ("https://mcp.otter.ai", &["https://otter.ai"]),
    ("https://api.grain.com", &["https://api.grain.com", "https://grain.com"]),
    ("https://mcp.krisp.ai", &["https://api.krisp.ai", "https://mcp.krisp.ai"]),
    ("https://app.circleback.ai", &["https://app.circleback.ai"]),
    ("https://mcp.tldv.io", &["https://keycloak.tldv.io"]),
    // ── Finance / spend / payments ──
    ("https://mcp.ramp.com", &["https://api.ramp.com", "https://mcp.ramp.com"]),
    ("https://api.brex.com", &["https://accounts-api.brex.com", "https://api.brex.com"]),
    ("https://mcp.mercury.com", &["https://mcp.mercury.com"]),
    ("https://mcp.expensify.com", &["https://www.expensify.com"]),
    ("https://mcp.navan.com", &["https://login.navan.com"]),
    ("https://mcp.app.carta.com", &["https://mcp.app.carta.com"]),
    ("https://api.digits.com", &["https://api.digits.com"]),
    ("https://mcp.gocardless.com", &["https://mcp.gocardless.com"]),
    ("https://mcp.mercadopago.com", &["https://auth.mercadopago.com", "https://mcp.mercadopago.com"]),
    // ── Financial & market intelligence ──
    ("https://premium.mcp.pitchbook.com", &["https://premium.mcp.pitchbook.com"]),
    ("https://mcp.morningstar.com", &["https://mcp.morningstar.com"]),
    ("https://mcp.cbinsights.com", &["https://mcp.cbinsights.com"]),
    ("https://mcp.quartr.com", &["https://mcp.quartr.com"]),
    ("https://mcp.daloopa.com", &["https://mcp.daloopa.com"]),
    ("https://mcp.consensus.app", &["https://consensus.app"]),
    // ── HR / recruiting / learning ──
    ("https://mcp.api.gusto.com", &["https://mcp.api.gusto.com"]),
    ("https://api.letsdeel.com", &["https://api.letsdeel.com"]),
    ("https://mcp.ashbyhq.com", &["https://mcp-auth.ashbyhq.com"]),
    ("https://mcp.workable.com", &["https://mcp.workable.com", "https://workable.com"]),
    ("https://mcp.metaview.ai", &["https://auth.metaview.ai"]),
    ("https://mcp.indeed.com", &["https://apis.indeed.com", "https://secure.indeed.com"]),
    ("https://api.udemy.com", &["https://api.udemy.com"]),
    // ── Legal / compliance ──
    ("https://mcp-server.signnow.com", &["https://mcp-server.signnow.com"]),
    ("https://mcp.vanta.com", &["https://api.vanta.com", "https://app.vanta.com", "https://mcp.vanta.com"]),
    ("https://mcp.drata.com", &["https://drata-prod.us.auth0.com", "https://mcp.drata.com"]),
    // ── Productivity / PM / design ──
    ("https://mcp.figma.com", &["https://api.figma.com", "https://www.figma.com"]),
    ("https://mcp.miro.com", &["https://mcp.miro.com"]),
    ("https://mcp.lucid.app", &["https://mcp.lucid.app"]),
    ("https://mcp.productboard.com", &["https://mcp.productboard.com"]),
    ("https://mcp.aha.io", &["https://mcp.aha.io"]),
    ("https://mcp.shortcut.com", &["https://api.app.shortcut.com"]),
    ("https://ai.todoist.net", &["https://todoist.com"]),
    ("https://mcp.ai.teamwork.com", &["https://teamwork.com", "https://www.teamwork.com"]),
    ("https://mcp.calendly.com", &["https://calendly.com"]),
    ("https://mcp.mail.superhuman.com", &["https://mcp.auth.mail.superhuman.com"]),
    ("https://mcp.craft.do", &["https://mcp.craft.do"]),
    ("https://mcp.mem.ai", &["https://api.mem.ai", "https://mem.ai"]),
    ("https://mcp.gamma.app", &["https://auth.gamma.app"]),
    ("https://mcp.pitch.com", &["https://auth.pitch.com"]),
    ("https://app.eraser.io", &["https://app.eraser.io"]),
    ("https://mcp.jotform.com", &["https://oauth2.jotform.com"]),
    ("https://api.typeform.com", &["https://admin.typeform.com", "https://api.typeform.com"]),
    ("https://mcp.surveymonkey.com", &["https://mcp.surveymonkey.com"]),
    ("https://mcp-server.egnyte.com", &["https://mcp-oauth.egnyte.com"]),
    // ── Marketing / content / CMS ──
    ("https://ai-inc.mailchimp.com", &["https://ai-inc.mailchimp.com"]),
    ("https://mcp.customer.io", &["https://mcp.customer.io"]),
    ("https://api.ahrefs.com", &["https://ahrefs.com", "https://api.ahrefs.com", "https://app.ahrefs.com"]),
    ("https://mcp.semrush.com", &["https://api.semrush.com", "https://oauth.semrush.com"]),
    ("https://asset-management.mcp.cloudinary.com", &["https://asset-management.mcp.cloudinary.com"]),
    ("https://mcp.contentful.com", &["https://mcp.contentful.com"]),
    ("https://mcp.sanity.io", &["https://mcp.sanity.io"]),
    ("https://mcp.wix.com", &["https://mcp.wix.com"]),
    ("https://public-api.wordpress.com", &["https://public-api.wordpress.com"]),
    ("https://mcp.gitbook.com", &["https://oauth.gitbook.com"]),
    ("https://mcp.mintlify.com", &["https://mcp.mintlify.com"]),
    ("https://mcp.deepl.com", &["https://mcp.deepl.com"]),
    // ── Dev / infra / observability ──
    ("https://gitlab.com", &["https://gitlab.com"]),
    ("https://mcp.supabase.com", &["https://api.supabase.com"]),
    ("https://netlify-mcp.netlify.app", &["https://netlify-mcp.netlify.app"]),
    ("https://mcp.heroku.com", &["https://mcp.heroku.com"]),
    ("https://mcp.buildkite.com", &["https://mcp.buildkite.com"]),
    ("https://mcp.grafana.com", &["https://mcp.grafana.com"]),
    ("https://mcp.newrelic.com", &["https://login.newrelic.com", "https://mcp.newrelic.com"]),
    ("https://mcp.honeycomb.io", &["https://ui.honeycomb.io"]),
    ("https://mcp.incident.io", &["https://app.incident.io", "https://mcp.incident.io"]),
    ("https://mcp.rootly.com", &["https://rootly.com"]),
    ("https://bugsnag.mcp.smartbear.com", &["https://oauth.bugsnag.com"]),
    ("https://mcp.launchdarkly.com", &["https://app.launchdarkly.com", "https://mcp.launchdarkly.com"]),
    ("https://mcp.pscale.dev", &["https://app.planetscale.com", "https://auth.planetscale.com", "https://mcp.pscale.dev"]),
    ("https://mcp.prisma.io", &["https://auth.prisma.io", "https://mcp.prisma.io"]),
    ("https://mcp.instantdb.com", &["https://mcp.instantdb.com"]),
    ("https://mcp.algolia.com", &["https://dashboard.algolia.com"]),
    ("https://api.statsig.com", &["https://api.statsig.com"]),
    ("https://mcp.postman.com", &["https://mcp.postman.com"]),
    ("https://mcp.semgrep.ai", &["https://login.semgrep.dev"]),
    ("https://mcp.workos.com", &["https://signin.workos.com"]),
    ("https://mcp.stytch.dev", &["https://rustic-kilogram-6347.customers.stytch.com", "https://stytch.com"]),
    ("https://mcp.mux.com", &["https://auth.mux.com"]),
    ("https://mcp.knock.app", &["https://mcp.knock.app"]),
    ("https://mcp.lovable.dev", &["https://lovable.dev"]),
    ("https://mcp.retool.com", &["https://mcp.retool.com"]),
    ("https://api.telnyx.com", &["https://api.telnyx.com"]),
    ("https://mcp.jam.dev", &["https://api.jam.dev"]),
    ("https://mcp.globalping.dev", &["https://mcp.globalping.dev"]),
    // ── Data / AI ──
    ("https://mcp.airbyte.ai", &["https://mcp.airbyte.ai"]),
    ("https://api.motherduck.com", &["https://mcp-auth.motherduck.com"]),
    ("https://integrations.getmontecarlo.com", &["https://auth.getmontecarlo.com"]),
    ("https://mcp.atlan.com", &["https://mcp.atlan.com"]),
    ("https://huggingface.co", &["https://huggingface.co"]),
    // ── Automation / web data / search ──
    ("https://mcp.zapier.com", &["https://mcp.zapier.com"]),
    ("https://mcp.make.com", &["https://www.make.com"]),
    ("https://ifttt.com", &["https://ifttt.com"]),
    ("https://mcp.exa.ai", &["https://auth.exa.ai"]),
    ("https://mcp.tavily.com", &["https://mcp.tavily.com"]),
    ("https://mcp.firecrawl.dev", &["https://www.firecrawl.dev"]),
    ("https://mcp.apify.com", &["https://console-backend.apify.com", "https://console.apify.com"]),
    ("https://mcp.brightdata.com", &["https://brightdata.com"]),
    // ── Bring-your-own OAuth app (no DCR) ──
    ("https://mcp.docusign.com", &["https://account.docusign.com", "https://mcp.docusign.com"]),
    ("https://mcp.xero.com", &["https://identity.xero.com", "https://login.xero.com"]),
    ("https://mcp.frontapp.com", &["https://app.frontapp.com"]),
    ("https://mcp.smartsheet.com", &["https://api.smartsheet.com", "https://app.smartsheet.com", "https://mcp.smartsheet.com"]),
    ("https://mcp.mongodb.com", &["https://authorize.mongodb.com", "https://cloud.mongodb.com"]),
    ("https://mcp.circleci.com", &["https://app.circleci.com", "https://circleci.com", "https://mcp.circleci.com"]),
    ("https://mcp.chargebee.com", &["https://app.chargebee.com"]),
    ("https://bigquery.googleapis.com", &["https://accounts.google.com", "https://oauth2.googleapis.com"]),
    ("https://mcp.na1.ironcladapp.com", &["https://ironcladapp.com"]),
    ("https://api.harvey.ai", &["https://api.harvey.ai", "https://harvey-ai.us.auth0.com"]),
    ("https://mcp.tableau.com", &["https://sso.online.tableau.com"]),
    ("https://setup.shopify.com", &["https://setup.shopify.com"]),
];
